...
_RELIGION_TABLE = {
    "the holy nation": [
        ("Zealot Okranite", 40), ("Devout Okranite", 35), ("Observant Okranite", 15), ("Secular", 5), ("Narkoite", 5),
    ],
    "narkos disciples": [
        ("Zealot Narkoite", 35), ("Devout Narkoite", 35), ("Follower of Narko", 20), ("Secular", 10),
    ],
    "shek kingdom": [
        ("Devoted to Kral", 20), ("Follower of Kral", 35), ("Respectful of Kral", 25), ("Secular", 20),
    ],
    "kral's chosen": [
        ("Zealot of Kral", 45), ("Devoted to Kral", 35), ("Follower of Kral", 15), ("Secular", 5),
    ],
    "band of bones": [
        ("Zealot of Kral", 40), ("Devoted to Kral", 35), ("Follower of Kral", 20), ("Secular", 5),
    ],
    "berserkers": [
        ("Devoted to Kral", 30), ("Follower of Kral", 35), ("Zealot of Kral", 20), ("Secular", 15),
    ],
    "the order of chitrin": [
        ("Zealot Chitrinite", 35), ("Devout Chitrinite", 40), ("Chitrinite", 20), ("Secular", 5),
    ],
    "united cities": [
        ("Secular", 50), ("Agnostic", 20), ("Casual Okranite", 15), ("Observant Okranite", 10), ("Follower of Kral", 5),
    ],
    "traders guild": [
        ("Secular", 60), ("Agnostic", 25), ("Casual Okranite", 10), ("Follower of Kral", 5),
    ],
    "slave traders": [
        ("Secular", 50), ("Agnostic", 25), ("Casual Okranite", 20), ("Follower of Kral", 5),
    ],
    "anti-slavers": [
        ("Secular", 40), ("Agnostic", 25), ("Follower of Kral", 15), ("Casual Okranite", 10), ("Narkoite", 10),
    ],
    "flotsam ninjas": [
        ("Secular", 45), ("Agnostic", 30), ("Narkoite", 15), ("Follower of Kral", 10),
    ],
    "hounds": [
        ("Secular", 55), ("Agnostic", 30), ("Casual Okranite", 15),
    ],
    "tech hunters": [
        ("Secular", 55), ("Agnostic", 30), ("Casual Okranite", 10), ("Follower of Kral", 5),
    ],
    "holy nation outlaws": [
        ("Secular", 40), ("Agnostic", 25), ("Narkoite", 20), ("Casual Okranite", 10), ("Follower of Kral", 5),
    ],
    ...
    "highlanders": [
        ("Secular", 35), ("Agnostic", 25), ("Casual Okranite", 25), ("Follower of Kral", 15),
    ],
    # "dark hive" intentionally omitted — all Hiver members get "Hiveless" before table lookup (collapsed Queen-structure)
    "_default": [
        ("Secular", 45), ("Agnostic", 25), ("Casual Okranite", 15), ("Follower of Kral", 10), ("Narkoite", 5),
    ],
}
